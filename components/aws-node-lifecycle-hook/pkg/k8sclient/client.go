...
//go:generate go run github.com/maxbrunsfeld/counterfeiter/v6 -o ./fakek8sclient/fake_k8sclient.go . Client

type Client interface {
	clientset.Interface
}

//go:generate go run github.com/maxbrunsfeld/counterfeiter/v6 -o ./fakek8sclient/fake_corev1.go . CoreV1Interface

type CoreV1Interface interface {
	v1g.CoreV1Interface
}

//go:generate go run github.com/maxbrunsfeld/counterfeiter/v6 -o ./fakek8sclient/fake_nodeinterface.go . NodeInterface
