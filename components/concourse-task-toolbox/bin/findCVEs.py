...
GLOBAL_IMAGE_WHITELIST = [
    ...
    'quay.io/prometheus/node-exporter:v1.0.0', # error in image scan: scan failed: failed to apply layers: unknown OS
    'quay.io/prometheus/prometheus:v2.18.1', # error in image scan: scan failed: failed to apply layers: unknown OS
